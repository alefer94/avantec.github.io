                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12 text-center">
                                <h6 class="banner-title m-b0">WHAT'S YOUR SEO SCORE</h6>
                                <h2 class="banner-stitle m-b55 xs-m-b40">We are Full Service<br><span class="text-second">SEO Agency</span></h2>
                                <div class="wpcf7">
                                    ...
                                    <form action="seoform.php" method="POST" class="wpcf7-form">
                                        <div class="seo-score one-line-form">
                                            <span class="wpcf7-form-control-wrap your-url">
                                                <input type="url" name="url" value="" size="40" class="wpcf7-form-control wpcf7-text wpcf7-url" placeholder="Your Website URL" required="">
                                            </span>
                                            ...
                                            <button type="submit" class="octf-btn octf-btn-icon octf-btn-primary">Start Now<i class="flaticon-right-arrow-1"></i></button>
                                        </div>
                                    </form>
                                </div>
                            </div>
           ...
           <!-- FIN HEADER--> 
            ...
            <section class="about-home bg-light">
                <div class="container">
                    <div class="about-home-img text-center">
                        <img src="img/BP_BITUP.png" alt="onum">
                    </div>
                </div>
            </section>
                ...
                <div class="container">
                    <div class="row flex-row">
                        <div class="col-lg-6 col-md-12 col-xs-12 xs-p-b50 text-center">
                            <img src="img/services1.png" class="" alt="onum">
                        </div>
                        <div class="col-lg-6 col-md-12 col-xs-12 p-l95 xs-p-l15 p-r0 xs-p-r15 align-self-center">
                            <div class="ot-heading left-align">
                                <h6><span>about us</span></h6>
                                <h2 class="main-heading m-b20">Grow Your Business<br>with Our SEO Agency</h2>
                            </div>
                            <p class="font22 text-dark">Over 10 years Onum helping companies reach their financial and branding goals.</p>
                            <p class="m-b0 p-b45">Over the years, we have worked with Fortune 500s and brand-new startups. We help ambitious businesses like yours generate more profits by building awareness, driving web traffic, connecting with customers, and growing overall sales. Give us a call.</p>
                            <div class="ot-button">
                                <a href="#" class="octf-btn octf-btn-secondary octf-btn-icon"><span>Learn More <i class="flaticon-right-arrow-1"></i></span></a>
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="partners-slide">
                                        <a href="#" class="client-logo">
                                            <figure class="partners-slide-inner">
                                                <img class="partners-slide-image" src="https://via.placeholder.com/137x30.png" alt="">
                                            </figure>                             
                                        </a>
                                    </div>
                                    <div class="partners-slide">
                        ...
                        <div class="col-md-4 no-padding">
                            <div class="icon-box">
                                ...
                                <div class="content-box">
                                    ...
                                    <p>Target your ideal search phrases and get  found at the top of Google’s search results. PPC allows you.immediate</p>
                                </div>
                            </div>
                        </div>
                    </div>   
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 sm-p-b60">
                            <div class="ot-pricing-table bg-shape s2">
                                ...
                                <div class="inner-table">
                                    <img src="https://via.placeholder.com/93x116.png" alt="Economy">
                                    <h2><sup>$</sup> 79.99</h2>
                                    <p>Monthly Package</p>
                                    <div class="details">
                                        <ul>
                        ...
                        <div class="col-md-4">
                            <div class="ot-pricing-table bg-shape s3">
                                ...
                                <div class="inner-table">
                                    <img src="https://via.placeholder.com/93x116.png" alt="Executive">
                                    <h2><sup>$</sup> 89.99</h2>
                                    <p>Monthly Package</p>
                                    <div class="details">
                                        <ul>
            ...
            <section class="p-b130 bg-counter">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="shadow-primary p-t100 p-b100 btn-rounder bg-cover text-center m-t--140" style="background: url('images/bg-counter-1.jpg') center center no-repeat;">
                                <div class="bg-overlay"></div>
                                <div class="row">
                            ...
                            <div class="p-t120">
                                <div class="row flex-row align-items-end">
                                    ...
                                    <div class="col-lg-6 col-md-12 col-xs-12 text-center">
                                        <img src="https://via.placeholder.com/570x423.png" alt="seo">
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-1/5 col-sm-6 col-xs-12">
                        <div class="team-wrap sm-p-t0 p-t200">
                            <div class="team-thumb">
                                <img src="https://via.placeholder.com/356x356.png" alt="Gina Bruno">
                            </div>
                            <div class="team-info">
                                <h4>Gina Bruno</h4>
                    ...
                    <div class="col-md-1/5 col-sm-6 col-xs-12">
                        <div class="team-wrap sm-p-t50 p-t150">
                            <div class="team-thumb">
                                <img src="https://via.placeholder.com/356x356.png" alt="David Ferry">
                            </div>
                            <div class="team-info">
                                <h4>David Ferry</h4>
                    ...
                    <div class="col-md-1/5 col-sm-6 col-xs-12">
                        <div class="team-wrap sm-p-t0 p-t100">
                            <div class="team-thumb">
                                <img src="https://via.placeholder.com/356x356.png" alt="Christina Tores">
                            </div>
                            <div class="team-info">
                    ...
                    <div class="col-md-1/5 col-sm-6 col-xs-12">
                        <div class="team-wrap p-t50">
                            <div class="team-thumb">
                                <img src="https://via.placeholder.com/356x356.png" alt="Regina Blackly">
                            </div>
                            <div class="team-info">
                    ...
                    <div class="col-md-1/5 col-sm-6 col-xs-12">
                        <div class="team-wrap">
                            <div class="team-thumb">
                                <img src="https://via.placeholder.com/356x356.png" alt="Olivia Chee">
                            </div>
                            <div class="team-info">
                                <h4>Olivia Chee</h4>
                            ...
                            <div class="ot-testimonials">
                                <div class="testimonial-wrap">
                                    <div class="testimonial-inner ot-testimonials-slider">
                                        <div>
                                            <img src="https://via.placeholder.com/100x100.png" alt="Michael Terry">
                                            <div class="ttext">
                                        ...
                                        <div>
                                            <img src="https://via.placeholder.com/100x100.png" alt="Emilia Clarke">
                                            <div class="ttext">
                                        ...
                                        <div>
                                            <img src="https://via.placeholder.com/100x100.png" alt="Cristian Torres">
                                            <div class="ttext">
            ...
            <section class="p-t330 p-b210 cta bg-cta particles-js" data-color="#fe4c1c,#00c3ff,#0160e7" data-id="i1-1">
                ...
                <div class="container">
                    <div class="cta-content text-center">
                        <h2 class="m-b20">Take Your Website to Next<br>Level Right Now!</h2>
                        <p class="m-b35">Make the Right Choice for Your Future. Choose Onum!</p>
                        <div class="ot-button">
        ...
        <section class="home5-video particles-js" data-color="#fe4c1c,#00c3ff,#0160e7" data-id="i5-4">
            <div class="bg-overlay"></div>
            <div class="container">
                <div class="row">
                    <div class="col-md-12 col-xs-12 text-center">
                        <h2>Expect Great Things from <br> Your SEO Agency</h2>
                        <p class="m-b50">Make the Right Choice for Your Future. Choose Onum!</p>
                        <div class="video-popup">
                            <div class="btn-inner">
                                <a class="btn-play" href="https://vimeo.com/214162786"><i class="fas fa-play"></i>
                                ...
                                <div class="col-md-6 col-sm-12 col-xs-12">
                                    <div role="form" class="wpcf7">
                                        <form action="newsletter.php" method="POST" class="wpcf7-form">
                                            ...
                                            <span class="wpcf7-form-control-wrap your-email">
                                                <input type="email" name="email" value="" size="40" class="wpcf7-form-control wpcf7-text wpcf7-email" aria-invalid="false" placeholder="Your Email" required="true"></span>
